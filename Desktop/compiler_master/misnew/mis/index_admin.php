...
<html lang="en">
	...
	<!--	<script>
		...
		var obj=$("#datalist-2").find("option[value='"+val+"']")
...
$('li > a').click(function() {
	...
	<body class="no-skin">
		...
		<div class="main-container" id="main-container">
				...
				<div class="col-sm-12">
										<div class="tabbable">
											<ul class="nav nav-tabs padding-12 tab-color-blue background-blue" id="myTab4">
												<li class="active">
													<a class="menu" data-toggle="tab" href="#home4">Search by user</a>
												</li>
											...
											<div class="tab-content" id="h4">
												...
												<div class="row">
													<?php
														...
														$query=mysql_query("select * from cc_users");
			...
			?>
			<option value="<?php echo $country["username"]; ?>"><?php echo $country["username"]; ?></option>
			<?php
			}
			?>
			</select>
