...
$row=mysql_fetch_array($result);
  $id=$row['id'];
$qry1=mysql_query("select * from cc_user_groups where user_id='$id'");
$row1 = mysql_fetch_array($qry1);
$gid=$row1['group_id'];
$qry2 = mysql_query("select * from cc_groups where id='$gid'");
if (!$qry2) { // add this check.
...
if($gname=="mentor") {
header("Location:../../misnew/exercise.php");
}
if($gname=="user") {
header("Location:../../misnew/manage_user.php");
}
