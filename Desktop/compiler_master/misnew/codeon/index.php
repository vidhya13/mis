			...
			<table class="code">
				...
				<form action="compile.php" method="post" id="form">
					Select Language of Interest:
						...
						<a href="../playground.php"  style="margin-left:200px" class="btn btn-primary btn-sm"><< Back</a>
					<br />
					<div  style="margin-top:10px">
					<strong>Enter Your code here:<br/></strong>
					<textarea style="background-color:black"name="code" rows=15 cols=150 onkeydown=insertTab(this,event) id="code"></textarea><br/>
					...
					<input class="btn btn-primary btn-sm" type="submit" va	lue="Submit" id="submit">
					<input class="btn btn-primary btn-sm" type="reset" value="Reset"><br/>
