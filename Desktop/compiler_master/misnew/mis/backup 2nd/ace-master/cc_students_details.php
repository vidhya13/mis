				...
				<ul class="nav nav-list">
					...
					<li class="no-padding-bottom">
						<a href="cc_mentis_details.php">
							...
							<span class="menu-text"><small><b> Mentor & Mentis Details</b></small> </span>						</a>
					...
					<li class="no-padding-bottom">
						<a href="add_mentis.php">
							...
							<span class="menu-text"><small><b> Assign Mentis Here</b></small> </span>						</a>
								...
								<div class="row">
									<div class="col-xs-12">
										...
										<div class="table-header">
											Results for "Registered Students"
...
$sql = " SELECT id,username,firstname,phonenumber,email,IsMentor from cc_users";
   ...
   function clickAndDisable(link) {
     ...
     link.onclick = function(event) {
        event.preventDefault();
														...
														<?php
														echo'<a class="green" href="cc_students_details.php? id=' .$row['id'].' " href="#modal-table" role="button"  data-toggle="modal" >
															...
															<div class="hidden-md hidden-lg">
																<div class="inline pos-rel">
																	...
																	<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
																		...
																		<a href="delete.php" class="tooltip-error" data-rel="tooltip" title="Delete">
																			<span class="red">
