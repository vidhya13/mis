...
ini_set('error_reporting', 0);
$conn=mysql_connect('10.100.1.153','demo','demo@123');
...
$db_selected = mysql_select_db('cloudcoderdb', $conn);
if (!$db_selected) {
    die ('Can\'t use  cloudcoderdb: ' . mysql_error());
}
else{
...
$sql = "SELECT course_id, title FROM cc_courses INNER JOIN (select * from cc_course_registrations where user_id = '2901') AS cc ON cc_courses.id = cc.course_id ";
//$sql = "SELECT title FROM cc_courses  ";
//$sql="SELECT user_id,username FROM cc_users;";
...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>Dashboard - KG Cloud Coder Mentor</title>
				...
				<div class="navbar-header pull-left">
					<a href="index.html" class="navbar-brand">
						<small>
							...
							KG Cloud Coder Mentor						</small>					</a>				</div>
				...
				<ul class="nav nav-list">
					<li class="active">
						<a href="#">
							...
							<span class="menu-text"> Dashboa </span>						</a>
					...
					<li class="no-padding-bottom">
						<a href="mentis_information.php">
							...
							<span class="menu-text"><small><b> Mentis Details</b></small> </span>						</a>
					...
					<li class="no-padding-bottom">
						<a href="add_mentis.php">
						    
							<i class="menu-icon fa fa-plus"></i>
							<span class="menu-text"><small><b> Add Mentis Here</b></small> </span>						</a>
							...
							<div class="col-xs-12 col-sm-6">
								...
								<div class="widget-box">
												<div class="widget-header">
													<h4 class="widget-title">Assign mentis</h4>
									...
									<form action="assign_mentis.php" method="post" class="form-horizontal" role="form">
													...
													<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Menti I </label>

										<div class="col-sm-9">
											<input type="text" name="menti_I" id="form-field-1" placeholder="Menti's username" class="col-xs-10 col-sm-7" required />
										</div>
									</div>
...
// As output of $_POST['mentor']  to display individual value
	...
	$menti_I 		= $_POST['menti_I'];
	$menti_II 		= $_POST['menti_II'];
	$menti_III 		= $_POST['menti_III'];
	$menti_IV 		= $_POST['menti_IV'];
	$menti_V 		= $_POST['menti_V']; 
	


//echo "You have selected :" .$select;  Displaying Selected Value
$sql1 = "update mentor_mentis set menti_I='$menti_I', menti_II='$menti_II', menti_III='$menti_III', menti_IV='$menti_IV', menti_V='$menti_V'  where username='$mentor_name'";
