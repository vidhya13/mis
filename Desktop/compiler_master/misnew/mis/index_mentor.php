	...
	<body class="no-skin">
		...
		<div class="main-container" id="main-container">
			...
			<div class="main-content">
				...
				<div class="col-sm-12">
										<div class="tabbable">
											<div class="nav nav-tabs padding-12 tab-color-blue background-blue" id="myTab4">
												<h4>Search</h4>
												</div>
			...
			<div class="col-sm-9">
			<input type="text" name="username" list="datalist-2" placeholder="select username" id="form-field-1"  class="col-xs-6 col-sm-8" onChange="getState(this.value);"  />
