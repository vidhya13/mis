  ...
  <div class="main-content">
		...
		<br/>
			...
			<span class="btn btn-app btn-sm btn-danger no-hover">
					...
					<?php
$myfile = fopen("notefiles/sub_recipt.txt", "r") or die("Unable to open file!");
echo fread($myfile,filesize("notefiles/sub_recipt.txt"));
fclose($myfile);
?>
					</span>
			...
			<div class="col-xs-2 col-sm-2">
		          ...
		          <span class="btn btn-app btn-sm btn-success no-hover">
					...
					<?php
$myfile = fopen("notefiles/tc_result.txt", "r") or die("Unable to open file!");
echo fread($myfile,filesize("notefiles/tc_result.txt"));
fclose($myfile);
?>
</span>
          ...
          <div class="col-xs-2 col-sm-2">
		         ...
		         <span class="btn btn-app btn-sm btn-primary no-hover">
													<span class="line-height-1 bigger-170">
					<?php
$myfile = fopen("notefiles/solved_problem.txt", "r") or die("Unable to open file!");
echo fread($myfile,filesize("notefiles/solved_problem.txt"));
fclose($myfile);
?>
					</span>
	...
	<span class="line-height-1 bigger-170">
					<?php
$myfile = fopen("notefiles/test_cases.txt", "r") or die("Unable to open file!");
echo fread($myfile,filesize("notefiles/test_cases.txt"));
fclose($myfile);
?></span>
		            <h4> Test<br/>
					Cases</h4>
			...
			<div class="col-sm-2 col-xs-2">
		          ...
		          <span class="btn btn-app btn-sm btn-pink no-hover">
													<span class="line-height-1 bigger-170">
					<?php
$myfile = fopen("notefiles/course_reg.txt", "r") or die("Unable to open file!");
echo fread($myfile,filesize("notefiles/course_reg.txt"));
fclose($myfile);
?></span>
		            <h4>Course <br/>
					Registrations</h4>
			...
			<div class="col-sm-2 col-xs-2">
		          ...
		          <span class="btn btn-app btn-sm btn-purple no-hover">
					<span class="line-height-1 bigger-170">
					<?php
$myfile = fopen("notefiles/users.txt", "r") or die("Unable to open file!");
echo fread($myfile,filesize("notefiles/users.txt"));
fclose($myfile);
?></span>
<br/>
<br/>
		...
		<span class="btn btn-app btn-sm btn-grey no-hover">
				...
				$myfile = fopen("notefiles/courses.txt", "r") or die("Unable to open file!");
					echo fread($myfile,filesize("notefiles/courses.txt"));
					fclose($myfile); 
