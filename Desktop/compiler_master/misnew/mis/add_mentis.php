...
$sql = "Select mentor_id,mentor_username from cc_mentors where mentor_username='$username'";
		...
		<div class="main-container" id="main-container">
			...
			<div id="sidebar" class="sidebar                  responsive">
				...
				<ul class="nav nav-list">
					...
					<li class="no-padding-bottom">
						<a href="mentis_information.php">
						    
							<i class="menu-icon fa fa-graduation-cap"></i>
							<span class="menu-text"><small><b> Mentee Details</b></small> </span>						</a>
					...
					<li class="active">
						<a href="#">
							...
							<span class="menu-text"><small><b> Add Mentees Here</b></small> </span>						</a>
					...
					<!--	<li class="no-padding-bottom">
						<a href="cc_userlog.php">
							...
							<span class="menu-text"><small><b> Mentis log</b></small> </span>						</a>

						<b class="arrow"></b>					</li>	-->
					
					<li class="no-padding-bottom">
						<a href="menti_graph.php">
...
<br>
							...
							<div class="col-xs-12 col-sm-6">
								...
								<div class="widget-box">
												<div class="widget-header">
													<h4 class="widget-title">Assign mentees</h4>
									...
									<form action="add_mentis.php" method="post" class="form-horizontal" role="form">
						...
						$result_users = mysql_query($sql_users);
								...
								<!--	<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Menti II </label>

										<div class="col-sm-9">
											<input type="text" name="menti_II" id="form-field-1" placeholder="Menti's username" class="col-xs-10 col-sm-7" required />
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Menti III </label>

										<div class="col-sm-9">
											<input type="text" name="menti_III" id="form-field-1" placeholder="Menti's username" class="col-xs-10 col-sm-7" required />
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Menti IV </label>

										<div class="col-sm-9">
											<input type="text" name="menti_IV" id="form-field-1" placeholder="Menti's username" class="col-xs-10 col-sm-7" required />
										</div>
									</div>
									
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Menti V </label>

										<div class="col-sm-9">
											<input type="text" name="menti_V" id="form-field-1" placeholder="Menti's username" class="col-xs-10 col-sm-7" required />
										</div>
									</div>-->
...
if($check_rows > 0)
{
	...
	window.location.href = 'add_mentis.php';</script>"; 
	exit;
}
else{
