...
! function(a, b, c) {
    ! function(a) {
        ...
        function Kb(b, c, d, e) {
            if (d = "DataTables warning sorry: " + (null !== b ? "table id=" + b.sTableId + " - " : "") + d, e && (d += ". For more information about this error, please see http://datatables.net/tn/" + e), c) a.console && console.log && console.log(d);
            else {
                var f = Wb.ext,
