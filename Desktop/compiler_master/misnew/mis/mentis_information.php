...
$sql = "Select mentee_username from cc_mentor_mentees where mentor_username='$username'";
...
<html lang="en">
	...
	<body class="no-skin">
		...
		<div class="main-container" id="main-container">
				...
				<ul class="nav nav-list">
					...
					<li class="active">
						<a href="#">
							...
							<span class="menu-text"><small><b> Mentees Details</b></small> </span>						</a>
				...
				<div class="main-content-inner">
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li class="active">View Your Mentees </li>
						</ul><!-- /.breadcrumb -->
							...
							<div class="col-xs-12 col-sm-6">
								...
								<div class="widget-box">
												<div class="widget-header">
													<h4 class="widget-title">View mentee Information</h4>
			...
			?>
			<option value="<?php echo $mentee_username;?>"><?php echo $mentee_username;?></option>
			<?php } ?>
			</select>
			&nbsp;&nbsp; 
...
// As output of $_POST['mentor']  to display individual value
	...
	$menti_uname 	= $_POST['menti_uname'];

//echo "You have selected :" .$select;  Displaying Selected Value
$sql1 = "SELECT username,firstname,phonenumber,email FROM cc_users where username='$menti_uname'";
...
<div class="profile-user-info profile-user-info-striped">
												...
												<div class="profile-info-row">
													...
													<div class="profile-info-value">
														<span class="editable" id="username"><?php echo$row['firstname'];?> </span>
													</div>
												</div>
												<div class="profile-info-row">
													<div class="profile-info-name"> PhoneNumber </div>

													<div class="profile-info-value">
														<span class="editable" id="username"><?php echo$row['phonenumber'];?> </span>
													</div>
												</div>
												<div class="profile-info-row">
													...
													<div class="profile-info-value">
														<span class="editable" id="username"><?php echo$row['email'];?> </span>
													</div>
												</div>
